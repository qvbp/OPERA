...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='./bge-large-en-v1.5',
                       help='BERT模型路径')
    parser.add_argument('--input_file', type=str, default='../data/pro_emb/qid_final/3/clean_final_qid.json',
                       help='输入JSON文件路径')
    parser.add_argument('--output_file', type=str, default='../data/pro_emb/qid_final/3/question_embeddings_only_qtext.npy',
                       help='输出numpy文件路径')

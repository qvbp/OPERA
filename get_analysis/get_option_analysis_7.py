...
class TextOnlyOptionAnalyzer:
    def __init__(self, api_key: str, base_url: str = "xxxx", log_dir: str = "logs"):
...
if __name__ == "__main__":
    ...
    try:
        ...
        results = analyzer.batch_analyze_multithreaded(
            data_file="../get_analysis/7/result/failed_0723.json",
            output_dir="../get_analysis/7/results_individual_0723_v1",
        ...
        failed_data = analyzer.export_failed_questions(
            results, "../get_analysis/7/result/failed_questions_0723_v1.json"
        )
        ...
        if summary["失败题目ID"]:
            ...
            analyzer.logger.info(f"- 失败题目详细信息已保存到: failed_questions_no_jy_v1.json")

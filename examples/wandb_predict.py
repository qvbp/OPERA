...
def main(params):
    ...
    with open(os.path.join(save_dir, "config.json")) as fin:
        ...
        if model_name in ["saint", "sakt", "atdkt", "sakt_pro", "sakt_enhance_pro"]:
    ...
    if model_name not in ["dimkt"]:        
        ...
        # test_loader = init_test_datasets(data_config, model_name, batch_size)
    ...
    model = load_model(model_name, model_config, data_config, emb_type, save_dir, dataset_name)

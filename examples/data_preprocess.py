...
dname2paths = {
    ...
    "zymath4": "../data/zymath4/zymath4.csv",
    "xxjv3": "../data/xxjv3/practice_record_dump_0~2025.02.25_clean_add_info_grade3_kc_question_mapping_norepeat.csv",
    "xxjv4": "../data/xxjv4/practice_record_dump_0~2025.02.25_clean_add_info_grade3_kc_question_mapping_norepeat.csv",
    "xxjv5_noimg": "../data/xxjv5_noimg/practice_record_dump_0~2025.02.25_clean_add_info_grade3_kc_question_mapping_norepeat.csv",
    "THINK":"../data/THINK/grade_3_data_en.csv",
    "MATH_G4-5":"../data/MATH_G4-5/grade_4_5_data.csv",
    "MATH_G7":"../data/MATH_G7/grade_7_data.csv",
}

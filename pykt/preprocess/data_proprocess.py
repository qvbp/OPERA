...
def process_raw_data(dataset_name,dname2paths):
    ...
    elif dataset_name == "zymath4":
        from .zymath4_preprocess import read_data_from_csv
    elif dataset_name == "THINK":
        from .xxj4_preprocess_en import read_data_from_csv
    elif dataset_name == "MATH_G4-5":
        from .xxj4_preprocess import read_data_from_csv
    elif dataset_name == "MATH_G7":
        from .xxj4_preprocess import read_data_from_csv
